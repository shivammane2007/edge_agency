...
const GridCard: React.FC<{ className?: string; children: React.ReactNode; }> = ({ className = '', children }) => (
  <motion.div
    ...
    className={`relative overflow-hidden rounded-3xl p-8 bg-gray-100 dark:bg-gray-900/50 ring-1 ring-black/5 dark:ring-white/10 transition-all duration-300 hover:scale-[1.02] hover:ring-black/10 dark:hover:ring-white/20 ${className}`}
  >
    {children}
  </motion.div>
);
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400">One subscription. Unlimited scale.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GridCard className="md:col-span-2">
          <h3 className="text-2xl font-bold">UI/UX Design</h3>
          <p className="mt-2 text-gray-500 dark:text-gray-400">From wireframes to pixel-perfect designs, we create intuitive and beautiful interfaces.</p>
          <div className="mt-8 h-48 rounded-xl bg-white dark:bg-black/50 p-4 ring-1 ring-inset ring-black/5 dark:ring-white/10">
            <div className="flex space-x-2">
              <div className="w-3 h-3 rounded-full bg-red-500"></div>
              <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
              <div className="w-3 h-3 rounded-full bg-green-500"></div>
            </div>
            <div className="mt-4 h-2 w-24 bg-gray-200 dark:bg-gray-700 rounded-full"></div>
            <div className="mt-2 h-2 w-32 bg-gray-200 dark:bg-gray-700 rounded-full"></div>
        ...
        <GridCard>
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">Integrate intelligent systems to automate workflows and enhance capabilities.</p>
        ...
        <GridCard className="md:col-span-3">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">High-performance web applications built with modern frameworks like React and Next.js.</p>
