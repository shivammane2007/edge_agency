...
export function ContainerScrollInset({
  ...
  const { scrollYProgress } = useContainerScrollAnimationContext();
  const insetY = useTransform(scrollYProgress, inputRange, (insetRangeY as number[]));
  const insetX = useTransform(scrollYProgress, inputRange, (insetXRange as number[]));
  const roundedness = useTransform(
    scrollYProgress,
    inputRange,
    (roundednessRange as number[]),
  );
...
export function ContainerScrollTranslate({
  ...
  const { scrollYProgress } = useContainerScrollAnimationContext();
  const y = useTransform(scrollYProgress, inputRange, (yRange as number[]));
  return (
    <motion.div
      style={{ y, ...style }}
...
export function ContainerScrollScale({
  ...
  const { scrollYProgress } = useContainerScrollAnimationContext();
  const scale = useTransform(scrollYProgress, inputRange, (scaleRange as number[]));
  return (
