...
const ParallaxImage: React.FC<{ src: string; alt: string }> = ({ src, alt }) => {
  ...
  return (
    <div ref={ref} className="relative h-[300px] sm:h-[400px] lg:h-[500px] overflow-hidden rounded-3xl ring-1 ring-white/10 gpu">
      <motion.img
        src={src}
        alt={alt}
...
const CaseStudies: React.FC = React.memo(() => {
  ...
  return (
    <section id="work" className="relative container mx-auto max-w-6xl px-4 py-16 space-y-8 gpu">
